...
<div id="wrapper">
 ...
 echo "<table border='1'>";
 echo "<tr>";
 echo "<th>Username</th><th>Password</th><th>Name</th><th>Address</th><th>City</th><th>State</th><th>Pin</th><th>Email id </th><th>Mobile No</th> ";
 echo "</tr>";
 while($row=mysql_fetch_array($result))
  {
    echo "<tr>";
	echo "<td><a href='deleteuser1.php?delete_n={$row['user']}'>",$row["user"],"</td>";
